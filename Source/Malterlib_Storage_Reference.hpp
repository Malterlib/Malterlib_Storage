...
namespace NMib::NStorage::NReference
{
	...
	mark_artificial inline_always NFunction::TCMemberFunctionBoundFunctor<t_CMemberPtr, t_CType *> TCReference<t_CType>::operator ->* (t_CMemberPtr const &_MemberPtr) const volatile
	...
	template <typename t_CType>
	template <typename t_CMemberPtr>
	mark_artificial inline_always auto TCReference<t_CType>::operator ->* (t_CMemberPtr const &_MemberPtr) const volatile
