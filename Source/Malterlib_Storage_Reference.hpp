...
namespace NMib::NStorage::NReference
{
	...
	mark_artificial inline_always t_CType &TCReference<t_CType, t_CPtr>::f_Get() const volatile
	{
	...
	template <typename t_CType, typename t_CPtr>
	mark_artificial inline_always TCReference<t_CType, t_CPtr>::operator t_CType & () const volatile
	{
		return this->f_Get();
	}
}
