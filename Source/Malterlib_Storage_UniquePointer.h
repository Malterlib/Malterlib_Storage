...
namespace NMib
{
	namespace NPtr
	{
		...
		template <typename t_CType, typename t_CAllocator = NMib::NMem::CDefaultAllocator, typename t_CPtr = TCDynamicPtr<typename t_CAllocator::CPtrHolder, t_CType>, typename t_CTag = typename NPrivate::TCUniquePointerTag<t_CType, t_CAllocator, t_CPtr>::CType>
