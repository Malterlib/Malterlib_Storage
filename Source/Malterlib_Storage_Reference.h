...
namespace NMib::NStorage::NReference
{
	...
	public:
		...
		[[gnu::artificial]] inline_always t_CType &f_Get() const volatile;
	public:
		[[gnu::artificial]] inline_always template <typename... tfp_CParams>
		typename TCEnableIf
		<
	...
	public:
		...
		TCReference(TCReference &&_Other);
		[[gnu::artificial]] inline_always operator t_CType & () const volatile;
	};
